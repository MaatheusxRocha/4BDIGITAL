    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            ...
            <div class="login-box-body">
                <p class="login-box-msg">Entre com seu e-mail e senha para poder ter acesso</p>
                <?= form_open('admin/login/submit', 'class="form-validate"') ?>
                <div class="form-group has-feedback">
                    <input type="email" name="login" class="form-control" placeholder="E-mail" required autofocus>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <a href="<?= site_url('admin/login/recover_password') ?>">Esqueci a Senha</a>
                    </div>
                    <div class="col-sm-6 text-right">
                        <a href="<?= site_url() ?>">Voltar ao site</a><br>
                    </div>
                </div>
            </div>
        </div>
